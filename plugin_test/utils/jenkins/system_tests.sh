...
# Export settings
if [ -z $NODE_VOLUME_SIZE ]; then export NODE_VOLUME_SIZE=350
if [ -z $OPENSTACK_RELEASE ]; then export OPENSTACK_RELEASE=Ubuntu
if [ -z $BONDING ]; then export BONDING=true
if [ -z $ENV_NAME ]; then export ENV_NAME="contrail"
