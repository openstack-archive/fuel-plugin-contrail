...
class ContrailPlugin(TestBasic):
    ...
    _pack_copy_path = '/var/www/nailgun/plugins/contrail-3.0'
    _add_ub_packag = \
    ...
    def _assign_net_provider(self, pub_all_nodes=False, ceph_value=False):
    ...
    def _prepare_contrail_plugin(
        ...
        # prepare fuel
        self._assign_net_provider(pub_all_nodes, ceph_value)
    ...
    def deploy_ha_with_pub_net_all_nodes(self):
        ...
        """
        self._prepare_contrail_plugin(slaves=9, pub_all_nodes=True)
...
#        :return:
        """
        self._prepare_contrail_plugin(slaves=9, ceph_value=True)
