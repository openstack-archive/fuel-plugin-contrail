contrail_ceph_multirole"""Copyright 2016 Mirantis, Inc.
    ...
    def contrail_ha_baseos(self):
        ...
        self.fuel_web.update_nodes(
            self.cluster_id,
            {
                ...
                'slave-04': ['base-os'],
                'slave-05': ['contrail-control', 'contrail-analytics'],
    ...
    def contrail_jumbo(self):
        ...
        self.fuel_web.update_nodes(
            self.cluster_id,
            {
                ...
                'slave-04': ['contrail-control', 'contrail-analytics'],
    ...
    def contrail_cinder_multirole(self):
        ...
        self.fuel_web.update_nodes(
            self.cluster_id,
            {
                ...
                'slave-04': ['compute'],
                'slave-05': ['compute'],
                'slave-06': ['contrail-control', 'contrail-analytics'],
                'slave-07': ['contrail-analytics', 'contrail-control'],
                'slave-08': ['contrail-analytics-db']
            })
