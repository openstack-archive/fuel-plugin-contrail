...
class DPDKTests(TestBasic):
    ...
    @test(depends_on=[SetupEnvironment.prepare_slaves_8],
    ...
    def contrail_ha_dpdk(self):
        ...
        """
        plugin.prepare_contrail_plugin(self, slaves=8,
    ...
    def contrail_dpdk_add_dpdk(self):
        ...
        Scenario:
            ...
            3. Deploy cluster with following node configuration:
                ...
                node-03: 'contrail-db';
                node-04: 'controller', 'ceph-osd', 'dpdk';
                node-05: 'controller', 'ceph-osd';
            4. Run OSTF tests
            6. Add one node with following configuration:
                node-6: "controller", "dpdk";
            7. Deploy changes
            8. Run OSTF tests
        ...
        conf_nodes = {
            ...
            'slave-02': ['contrail-config',
                         ...
                         'contrail-db'],
            'slave-03': ['contrail-db'],
            'slave-04': ['controller', 'ceph-osd', 'dpdk'],
            'slave-05': ['controller', 'ceph-osd'],
            # Here we add slave-06
        }
        conf_dpdk = {'slave-06': ['controller', 'dpdk']}
