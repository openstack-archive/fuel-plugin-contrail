...
class BMDriver(object):
    ...
    def update_node_interfaces(self, obj, node):
        ...
        def get_pxe_interface(macs):
            interfaces = obj.fuel_web.client.get_node_interfaces(node['id'])
            ...
            for iface in interfaces:
                ...
                if iface_pxe and iface_slave:
                    ...
                    return iface_pxe, iface_slave

            return None, None

        pxe_interface, hw = get_pxe_interface(target_macs)
        networks = {
            'eno1': ['public'],
            'eno2': [],
