...
def prepare_contrail_plugin(
        ...
        ephemeral_ceph=False, objects_ceph=False, volumes_lvm=False):
    ...
    # prepare fuel
    openstack.assign_net_provider(
        obj, pub_all_nodes, ceph_value, volumes_ceph, ephemeral_ceph, objects_ceph, volumes_lvm
    )
