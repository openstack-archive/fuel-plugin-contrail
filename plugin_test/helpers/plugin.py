...
def vsrx_multiple_networks(
    obj, vsrx_ip='10.109.4.250', net_name='private2'):
    """onfigure routing on vsrx to no default private network.
    ...
    """
    ip_private_net = obj.env.d_env.get_network(
