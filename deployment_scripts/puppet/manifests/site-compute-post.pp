...
case $operatingsystem {
  Ubuntu: {
    ...
    package { ['linux-image-3.13.0-62-generic','linux-headers-3.13.0-62-generic']:
      ensure => 'present',
    } ->
    exec { 'grub-set-default-kernel':
      command => 'grub-set-default "Advanced options for Ubuntu>Ubuntu, with Linux 3.13.0-62-generic"',
    } ->
