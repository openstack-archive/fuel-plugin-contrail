...
class contrail {
  ...
  $default_vm_image_path                      = "http://${::contrail::master_ip}:8080/plugins/contrail-3.0/ContrailVM-disk1.vmdk"
  $vmdk_vm_image                              = pick($settings['vm_image_path'], $default_vm_image_path)
