...
class contrail(
  ...
  $nc            = prepare_network_config($network_scheme),
  ...
  $rabbit_nodes_hash  = get_nodes_hash_by_roles(hiera_hash('network_metadata', {}), ['primary-controller', 'controller']),
  ...
  $primary_contrail_db_nodes_hash = get_nodes_hash_by_roles(hiera_hash('network_metadata', {}), ['primary-contrail-db']),
  $primary_contrail_db_ip         = values(get_node_to_ipaddr_map_by_network_role($primary_contrail_db_nodes_hash, 'neutron/mesh')),

  $contrail_db_nodes_hash         = get_nodes_hash_by_roles(hiera_hash('network_metadata', {}), ['primary-contrail-db', 'contrail-db']),
  ...
  $contrail_control_nodes_hash    = get_nodes_hash_by_roles(hiera_hash('network_metadata', {}), ['primary-contrail-control', 'contrail-control']),
  ...
  $contrail_config_nodes_hash     = get_nodes_hash_by_roles(hiera_hash('network_metadata', {}), ['primary-contrail-config', 'contrail-config']),
