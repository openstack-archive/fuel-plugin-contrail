...
--api_server_ip ${contrail_internal_vip} --oper add --admin_user ${keystone_admin_user} \
--admin_password ${keystone_admin_password} --admin_tenant_name ${service_tenant_name} \
