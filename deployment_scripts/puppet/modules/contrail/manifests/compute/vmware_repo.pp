...
#    command => 'sed -i -e \'/\x27python-oslo.vmware\x27:/,+2d\' compute_vmware.pp && touch /opt/contrail/patch_core_vmware_manifest1-DONE',
#    require => File['/opt/contrail'],
#    creates => '/opt/contrail/patch_core_vmware_manifest1-DONE',
#  }

#  exec { 'patch_core_vmware_manifest2':
#    path    => '/usr/local/bin:/bin:/usr/bin/',
#    cwd     => '/etc/puppet/modules/vmware/manifests',
#    command => 'sed -i \'/Package\[\x27python-oslo.vmware\x27\]/d\' compute_vmware.pp && touch /opt/contrail/patch_core_vmware_manifest2-DONE',
#    require => File['/opt/contrail'],
#    creates => '/opt/contrail/patch_core_vmware_manifest2-DONE',
#  }
