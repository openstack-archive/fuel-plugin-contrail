...
class contrail::compute::vmware_pkg {
  ...
  $vcenter_compute_pkgs = [
    'python-bitstring', 'nova-compute', 'nova-compute-kvm',
    'nova-common', 'nova-compute-libvirt', 'python-novaclient',
  ...
  package { ['libxml-commons-external-java', 'libxml-commons-resolver1.1-java',
    'libxerces2-java', 'libslf4j-java', 'libnetty-java',
    'libjline-java', 'libzookeeper-java']: } ->
