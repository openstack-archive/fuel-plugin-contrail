...
Puppet::Parser::Functions::newfunction( :vrouter_override_network_scheme,
    ...
    orig_ns['transformations'].each do |transformation|
      if transformation['action'] == 'add-bond' and transformation['name'] == interface_real and dpdk_enabled
        override['transformations'] << {'action'          => 'override',
                                        'override'        => interface_real,
                                        'override-action' => 'noop'}
      elsif transformation['action'] == 'add-port' and transformation['name'] == interface
        override['transformations'] << {'action'          => 'override',
                                        'override'        => interface,
                                        'override-action' => 'noop'}
      elsif transformation['action'] == 'add-br' and transformation['name'] == private_bridge
        override['transformations'] << {'action'          => 'override',
