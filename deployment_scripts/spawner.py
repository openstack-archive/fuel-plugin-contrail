...
class Vcenter_base(object):
    ...
    def connect_to_vcenter(self):
        ...
        """
        self.service_instance = connect.SmartConnect(host=self.options.host,
...
if __name__ == '__main__':
    ...
    vcenter_host, vcenter_username, vcenter_password = vcenter_base.get_vcenter_credentials(vcenter_base.options.env_id)
    ...
    storage_name = Vcenter_base.get_contrail_settings(vcenter_base.options.env_id, 'esxi_datastore_name')
