...
if [ -f "$UBUNTU_PKG" ];
then
  #Create link to newest version of contrail package
  relink $PLUGIN_PATH/contrail-install-packages.deb $UBUNTU_PKG

  #Create link to newest version of contrail vcenter plugin package
  relink $PLUGIN_PATH/contrail-install-vcenter-plugin.deb $VMWARE_PKG
