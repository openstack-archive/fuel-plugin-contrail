...
/usr/bin/dockerctl shell nailgun sed -i -e 's_vCenterNetworkBackends:["network:neutron:core:nsx"_vCenterNetworkBackends:["network:neutron:contrail","network:neutron:core:nsx"_' /usr/share/nailgun/static/build/bundle.js
