...
Additionally a few settings(Uplink name, Datastore name, DVS external, DVS internal, DVS private)
need to be added into the Fuel contrail tab. Description of settings
